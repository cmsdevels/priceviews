...
$(function () {
    ...
    $("#" + JsTreeBehavior.container_ID)
        .jstree({
            ...
            "core":{ "initially_open":JsTreeBehavior.open_nodes, 'open_parents':false},
            "themes":JsTreeBehavior.themes,
            "html_data":{
                "ajax":{
                    "type":"POST",
                    "url":Yii_js.baseUrl + "/" + JsTreeBehavior.controllerID + "/fetchStructureTree",
                    "data":function (n) {
                        return {
                ...
                $.ajax({
                    ...
                    success:function (r) {
                        ...
                        if (!response.success) {
                            ...
                            //if it's a copy
                            $(data.rslt.o).find('>a>span.actions>span.view').attr('data-href', response.viewUrl);
                            if (data.rslt.cy) {
