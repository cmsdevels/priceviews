...
class MultilingualBehavior extends CActiveRecordBehavior
{
    ...
    /**
     * @var string or array the scenario corresponding to the creation of the model. Default to 'insert'.
     */
	...
	public function afterConstruct($event) {
		$owner = $this->getOwner();
		if (($owner->scenario==$this->createScenario) || (is_array($this->createScenario) && in_array($owner->scenario, $this->createScenario))) {
